...
// 修改这里没有明显效果：
// #define SEND_ADV_TIMER_IRQ_MIN_INTERVAL							(1)//unit:ms
#define SEND_ADV_TIMER_IRQ_MIN_INTERVAL							(5)//unit:ms （SDK默认的值）
// #define SEND_ADV_TIMER_IRQ_MIN_INTERVAL							(15)//unit:ms
// #define SEND_ADV_TIMER_IRQ_MIN_INTERVAL							(30)//unit:ms
// #define SEND_ADV_TIMER_IRQ_MIN_INTERVAL							(60)//unit:ms
// #define SEND_ADV_TIMER_IRQ_MIN_INTERVAL							(255)//unit:ms
// #define SEND_ADV_TIMER_IRQ_MIN_INTERVAL							(65535)//unit:ms
